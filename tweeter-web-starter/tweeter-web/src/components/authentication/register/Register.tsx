  ...
  const inputFieldFactory = () => {
    return (
      <>
        ...
        <AuthenticationField originalUrl={undefined} alias={alias} authenticate={doRegister} buttonStatus={checkSubmitButtonStatus} setAlias={setAlias} setPassword={setPassword} /> 

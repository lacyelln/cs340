...
interface Props <T,U extends PagedItemPresenter<T, any>>{
  featureUrl: string;
  presenterFactory: (view: PagedItemView<T>) => U;
  itemComponentFactory: (item: T, featurePath: string) => JSX.Element;
}

const UserItemScroller = <T, U extends PagedItemPresenter<T, any>>(props: Props<T, U>) => {
